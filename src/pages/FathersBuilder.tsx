...
import { Zap, Send, Sparkles, ArrowLeft, Loader2, Save, Rocket, Eye, Download, ImagePlus, FolderTree, MessageSquare, ListChecks, FolderArchive } from "lucide-react";
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!session?.access_token) {
        throw new Error("Please sign in to use the AI builder.");
      }
  ...
  return (
    <div
      ...
      style={{
        ...
        "--accent": "215 72% 51%",
        "--ring": "215 72% 51%",
        "--glow-primary": "215 72% 51%",
        "--glow-secondary": "215 100% 70%",
        "--gradient-start": "215 72% 51%",
        "--gradient-end": "230 80% 55%",
        "--card": "215 20% 8%",
        "--secondary": "215 20% 12%",
        "--muted": "215 15% 15%",
        "--border": "215 15% 18%",
        "--input": "215 15% 18%",
        background: "linear-gradient(135deg, hsl(215 25% 5%), hsl(220 20% 8%), hsl(210 15% 6%))",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex h-16 items-center justify-between">
            <Link to="/home" className="flex items-center gap-2 group">
              <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-shadow duration-300 overflow-hidden">
                <img src={basketballLogo} alt="Basketball" className="h-7 w-7 object-contain" />
                <div className="absolute -inset-1 rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 opacity-0 group-hover:opacity-30 blur-lg transition-opacity" />
              </div>
              <div className="flex flex-col">
                <span className="text-lg font-black leading-tight">
                  Father's <span className="bg-gradient-to-r from-blue-400 via-sky-400 to-amber-400 bg-clip-text text-transparent">Builder</span> 🏀
                </span>
            ...
            <div className="flex items-center gap-2">
              <Link to="/fathers-day">
                <Button variant="ghost" size="sm" className="gap-1.5 text-blue-400 hover:text-blue-300 hover:bg-blue-500/10">
                  🏀
                  <span className="hidden sm:inline">Father's Day</span>
                </Button>
              </Link>
              ...
              >
                {msg.role === "assistant" && (
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-semibold text-blue-400">Father's AI 🏀</span>
                  </div>
                )}
